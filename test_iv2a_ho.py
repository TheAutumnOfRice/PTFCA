...
for subject in [1,2,3,4,5,6,7,8,9]:
    ...
    TX = np.load(fr"F:\dataset\BCICIV2AO\{subject}traindata.npy")  # 288 x 22 x 1000
    TY = np.load(fr"F:\dataset\BCICIV2AO\{subject}trainlabel.npy")  # 288
    EX = np.load(fr"F:\dataset\BCICIV2AO\{subject}testdata.npy")  # 288 x 22 x 1000
    EY = np.load(fr"F:\dataset\BCICIV2AO\{subject}testlabel.npy")  # 288
